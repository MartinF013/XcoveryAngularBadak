...
import { DocumentInfoTable } from '../../api/customer';
...
export class TablaHistorialComponent implements OnInit {
    ...
    tableDocuments: DocumentInfoTable[] = [];
    ...
    ngOnInit() {
        this.customerService.getInfoDocument().then(data => {
            this.tableDocuments = data;
            this.loading = false;
            console.log(this.tableDocuments)

            // @ts-ignore
            this.tableDocuments.forEach(document => {
                // @ts-ignore
                document.modifiedDate = new Date(document.modifiedDate);
                // @ts-ignore
                document.recievedDate = new Date(document.recievedDate);
